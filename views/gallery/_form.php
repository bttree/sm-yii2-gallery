...
<div class="panel">
        ...
        <div class="gallery-images">
            ...
            <div id="load_photo_btn">
                <a class="btn btn-info" href="<?= \Yii::$app->urlManager->createUrl(['/gallery/popup-upload', 'id' => $model->id]); ?>" id="upload_link" data-target="#popup-scene-upload" data-toggle="modal">
                    <span><?= Yii::t('backend', 'Load photo');?></span>
                </a>
            </div>
            ...
            <?php if($model->images): ?>
                ...
                {
                    $arrGrid[] = ["content" => "<div class='grid-item text-danger gallery-image' data-divid='". $picture->id ."'>
                                                    <img src='". $picture->getImageUrl(130) . "' style='height:130px;'>".
                        "<span class='glyphicon glyphicon-remove-circle' data-url='" . Url::to(['gallery/delete-photo','photo'=>$picture->id]) . "'></span>"
                        ."</div>"];
                }
